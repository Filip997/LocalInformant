        ...
        lifecycleScope.launch {
            repeatOnLifecycle(Lifecycle.State.STARTED) {
                homeViewModel.homeUiState.collect { state ->
                    ...
                    if (state.isLoading) {
                        binding.swipeRefreshLayoutHome.visibility = View.GONE
                        binding.layoutShimmerHome.startShimmer()
                        binding.layoutShimmerHome.isVisible = true
                    } else {
                        binding.layoutShimmerHome.stopShimmer()
                        binding.layoutShimmerHome.isVisible = false
                        binding.swipeRefreshLayoutHome.visibility = View.VISIBLE
                    }
